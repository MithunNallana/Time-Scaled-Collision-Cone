import numpy as np
from tscc.timescaling import timescaling
...
# limitsRobo['velocity'] has
# [velocity Minimum, velocity Maximum, velocity Desired]
# limitsRobo['omega'] has omegaMaximum
# limitsRobo['acceleraiton'] has
# [accelration-X Maximum, acceleration-X Minimum]
# note: acceleration-Y Maximum and Minimum are made equal to
# accelration-X Maximum, Minimum. 
#
limitsRobo = {}
...
# refer "Model predictive control in Autonomous Driving Based on
# TimeScaled Collision Cone" by Mithun et.al.
deltaT = 0.8
deltaTSmall = 0.1
